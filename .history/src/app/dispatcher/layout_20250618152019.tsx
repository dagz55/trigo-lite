...
import {
    ...
    Landmark,
    LayoutDashboard, // Renamed to avoid conflict with a potential local variable
            ...
            {isAuthenticated ? (
              ...
              <>
                <Button variant="default" className="w-full group-data-[collapsible=icon]:w-auto group-data-[collapsible=icon]:p-2" asChild>
                  <Link href="/dispatcher/register-toda">
                    <span style={{ display: "contents" }}>
                      <Landmark className="mr-2 h-4 w-4 group-data-[collapsible=icon]:mr-0" />
                      <span className="group-data-[collapsible=icon]:hidden">Register TODA</span>
                    </span>
                  </Link>
                </Button>
              </>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            {isAuthenticated ? (
              <DropdownMenu>
               ...
               <Button variant="default" size="icon" asChild className="md:hidden">
                  <Link href="/dispatcher/register-toda" aria-label="Register TODA">
