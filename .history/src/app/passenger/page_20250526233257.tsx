  ...
  return (
    <div className="bg-gray-50 text-black flex flex-col h-screen">
      ...
      <div className="relative flex-1">
        ...
        {(rideState.status === 'confirmingRide' || rideState.status === 'searching' || rideState.status === 'triderAssigned' || rideState.status === 'inProgress' || rideState.status === 'completed' || rideState.status === 'cancelled') && (
           <Alert
           ...
           >
             ...
             <AlertDescription className="space-y-1.5 text-white/90 text-sm">
               ...
               PASSENGER_HEADER_BG     <p>Ride Ticket #: {rideState.currentRideId}</p>
                }
