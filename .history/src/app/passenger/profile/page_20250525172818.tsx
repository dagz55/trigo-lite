...
import ApplePaymentSelector from "@/components/ApplePaymentSelector";
      ...
      <div className="flex-1 p-6 pb-20 overflow-y-auto">
        <div className="max-w-md mx-auto space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <ApplePaymentSelector
                paymentMethods={paymentMethods}
                selectedMethod={paymentMethods.find((method: PaymentMethod) => method.isDefault) || null}
                onSelect={handleSetDefaultPayment}
                className="w-full"
              />
            </CardContent>
          </Card>
