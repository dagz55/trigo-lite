           ...
           <Alert
            ...
            >
             ...
             <AlertDescription className="space-y-1.5 text-white/90 text-sm">
                ...
                {rideState.currentRideId && (rideState.status === 'searching' || rideState.status === 'triderAssigned' || rideState.status === 'inProgress' || rideState.status === 'completed' || rideState.status === 'cancelled') &&
