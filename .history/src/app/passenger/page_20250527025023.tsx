              ...
              {[{ label: "Ride", subLabel: "Before", icon: History, action: handleRideBefore },
               ...
               { label: "Ride", subLabel: "Later", icon: CalendarCheck2, action: handleRideLater }
                ...
                <div key={item.subLabel} className="enhanced-button-container">
                  ...
                  <Button
                    variant="outline"
                    className="glass-crystal-effect flex flex-col items-center justify-center h-24 w-24 rounded-full p-0 border-2 transition-all duration-200 ease-in-out hover:scale-105 focus:scale-105 active:scale-95 relative z-10"
                    style={{
