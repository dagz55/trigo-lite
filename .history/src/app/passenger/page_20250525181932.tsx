...
export default function PassengerPage() {
  ...
  const { defaultPaymentMethod } = useUser();
      ...
      <div className="relative flex flex-col h-screen bg-cover bg-center text-white"
        ...
        <div className="relative z-10 flex flex-col h-full p-6 pt-4">
          <header className="flex justify-end">
            <Button variant="ghost" size="icon" className="text-white hover:bg-white/20" title="Menu" onClick={handleMenuClick}>
              <MenuIcon size={28} />
          ...
          <div className="pb-4 relative">
            ...
            <footer className="text-center text-sm text-white/70">
              <button
                ...
                onClick={() => window.open('/passenger/profile', '_blank')}
              ...
              >
                ...
                <span className="ml-1" style={{color: PASSENGER_PAGE_ACCENT_COLOR_HSL}}>{'>'}</span>
              </button>
            </footer>
          </div>
        </div>
    ...
    <div className="bg-white text-black flex flex-col h-screen">
      <div style={{ backgroundColor: PASSENGER_HEADER_BG, color: PASSENGER_HEADER_TEXT }} className="p-4 flex items-center justify-between shadow-md z-20 relative">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button variant="ghost" size="icon" className="text-white hover:bg-white/20 hover:text-white" title="Change Map Style" onClick={handleMapStyleToggle}><MapIcon size={18}/></Button>
