...
import { PayMongoTopUp } from '@/components/payment/PayMongoTopUp';
...
export default function PassengerWalletPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-white px-2 text-muted-foreground">Or use secure payment</span>
                    </div>
                  </div>
                  ...
                  <Button 
                    ...
                    size="lg"
                    variant="default"
                    onClick={() => setShowPayMongoDialog(true)}
                  >
      ...
      {/* PayMongo Top-up Dialog */}
      <PayMongoTopUp
        isOpen={showPayMongoDialog}
        onOpenChange={setShowPayMongoDialog}
        onSuccess={handlePayMongoSuccess}
        userId="passenger-demo-123" // In production, get from auth
        userEmail="passenger@trigo.com" // In production, get from auth
        userName="Passenger Demo" // In production, get from auth
      />
    </div>
  );
}
