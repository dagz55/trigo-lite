    ...
    <div className="bg-gray-50 text-black flex flex-col h-screen">
      ...
      <div className="flex-1 p-6 pb-24">
        <div className="max-w-md mx-auto space-y-6">
          ...
          {/* Apple-style Features Card */}
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Map Features</h3>
            <div className="space-y-4">
              <div className="flex items-center">
                <div className="w-3 h-3 bg-purple-500 rounded-full mr-4"></div>
                <span className="text-gray-700 font-medium">Real-time trider locations</span>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-blue-500 rounded-full mr-4"></div>
                <span className="text-gray-700 font-medium">TODA zone boundaries</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700 font-medium">Traffic conditions</span>
              </div>
            </div>
          </div>
        </div>
