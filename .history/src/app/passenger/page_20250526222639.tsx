...
export default function PassengerPage() {
  ...
  const handleSavePassengerSettings = React.useCallback(() => {
    // Save all current settings to localStorage
    const settingsToSave = {
      mapStyle: currentPassengerSettings.mapStyle,
      animationSpeed,
      enableAnimations,
      enableSoundEffects,
    ...
    try {
      localStorage.setItem('triGoPassengerSettings', JSON.stringify(settingsToSave));
      handleStatusToast("Settings Saved", "Your TriGo settings have been saved successfully!");
    } catch (error) {
      console.error('Failed to save settings:', error);
      handleStatusToast("Save Failed", "Failed to save settings. Please try again.");
    }
  }, [
    currentPassengerSettings.mapStyle,
    animationSpeed,
