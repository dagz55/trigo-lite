...
import { MapPin, Users, Bike, LogIn, UserCircle, CircleDollarSign, CheckCircle, XCircle, Loader2, Send, Edit3, ChevronDown, ChevronUp, Minimize2, Maximize2 } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="flex-grow grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-4 md:p-4 overflow-hidden">
        <div className="md:col-span-1 flex flex-col gap-4 p-4 md:p-0 h-full">
          <CollapsibleCard id="active-ride" defaultCollapsed={true} title="Active Ride" badge={<Badge variant={triderState.status === 'offline' ? "destructive" : triderState.status === 'onlineAvailable' ? "default" : "secondary"} className="capitalize text-xs">
          ...
          <CollapsibleCard id="trider-profile" defaultCollapsed={true} title={<UserCircle className="mr-2"/>{triderProfile.name} current TODA: {triderProfile.todaZoneName} - {triderProfile.vehicleType}>}>
