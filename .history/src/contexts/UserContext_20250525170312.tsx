...
export const UserProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const debouncedSave = React.useCallback(async (userData: MockPassengerProfile | null, paymentData: PaymentMethod[]) => {
  ...
  React.useEffect(() => {
    try {
      ...
      if (storedUser || storedPaymentMethods) {
  ...
  React.useEffect(() => {
    ...
    if (autosave.lastSaved !== null || currentUser || paymentMethods !== defaultPaymentMethods) {
      debouncedSave(currentUser, paymentMethods);
    }
  }, [currentUser, paymentMethods, debouncedSave, autosave.lastSaved]);
