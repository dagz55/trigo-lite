...
export const UserProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  React.useEffect(() => {
    ...
    if (autosave.lastSaved !== null || currentUser || userProfile !== defaultUserProfile || paymentMethods !== defaultPaymentMethods) {
      debouncedSave(currentUser, userProfile, paymentMethods);
    }
  }, [currentUser, userProfile, paymentMethods, debouncedSave, autosave.lastSaved]);
