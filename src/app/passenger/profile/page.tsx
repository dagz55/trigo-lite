  ...
  return (
    <div className="bg-gray-50 text-black flex flex-col h-screen">
      ...
      <div className="bg-white/80 backdrop-blur-xl border-b border-gray-200/50 p-4 flex items-center justify-between shadow-sm z-20 relative">
        ...
        <Link href="/passenger/settings" className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors duration-200" title="Settings">
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span className="ml-1 text-sm font-medium">{userProfile.rating}</span>
                  <span className="ml-2 text-sm text-gray-500">({userProfile.totalRides} rides)</span>
                </div>
              </div>
            </CardContent>
          </Card>
