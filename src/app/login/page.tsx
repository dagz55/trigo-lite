...
export const metadata: Metadata = {
  title: "Login | TriGO",
  description: "Login to your TriGO account",
}
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-trigo-50 to-trigo-100 dark:from-trigo-900 dark:to-trigo-800 honeycomb-pattern">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-trigo-900 dark:text-white">Welcome to TriGO</h1>
          <p className="text-trigo-700 dark:text-trigo-300 mt-2">Sign in to your account to continue</p>
        </div>
